...
public class LocalStorageService {
  ...
  @Value("${app.uploads.croquis}")     private String dirCroquis;
  ...
  public void ensureDirs() {
    for (String d : new String[]{dirUsuarios, dirSemblanzas, dirReconocimientos, dirEquipamiento, dirFotografias, dirCroquis}) {
