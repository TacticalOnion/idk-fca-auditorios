...
INSERT INTO public.area (nombre, nombre_responsable, correo_responsable)
    ...
    ('Centro de Idiomas', 'Leticia Rivera', 'leticia.rivera@fca.unam.mx'),
...
INSERT INTO public.puesto (nombre, id_area) VALUES
    ('Coordinador de Administración Escolar del Centro de Idiomas', (SELECT id_area FROM public.area WHERE nombre = 'Centro de idiomas')),
...
VALUES
    ...
    ('Boletín algo más (reportero)',True,
        (SELECT id_area FROM public.area WHERE nombre = 'Publicaciones y Fomento Editorial')),
    ('Vigilancia',True,
        (SELECT id_area FROM public.area WHERE nombre = 'Secretaria Administrativa')),
    ('Presidium',True,
        (SELECT id_area FROM public.area WHERE nombre = 'Secretaria Administrativa')),
    ('Otros',True,
        (SELECT id_area FROM public.area WHERE nombre = 'Secretaria Administrativa')),
...
VALUES
    ...
    --      usuarios
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Superadministrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='usuario', accion='crear', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Superadministrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='usuario', accion='leer', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Superadministrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='usuario', accion='editar', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Superadministrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='usuario', accion='eliminar', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Superadministrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='usuario', accion='leer', alcance='propietario')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Superadministrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='usuario', accion='editar', alcance='propietario')),
    ...
    --      recintos
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='recinto', accion='crear', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='recinto', accion='leer', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='recinto', accion='editar', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='recinto', accion='eliminar', alcance='global')),
    
    --      reservaciones
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='reservacion', accion='leer', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='reservacion', accion='editar', alcance='global')),

    --      eventos
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='evento', accion='leer', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='evento', accion='editar', alcance='global')),

    --      inventarios
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='area_inventario', accion='crear', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='area_inventario', accion='leer', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='area_inventario', accion='editar', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='area_inventario', accion='eliminar', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='recinto_inventario', accion='crear', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='recinto_inventario', accion='leer', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='recinto_inventario', accion='editar', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='recinto_inventario', accion='eliminar', alcance='global')),

    --      catalogos
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='catalogo', accion='crear', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='catalogo', accion='leer', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='catalogo', accion='eliminar', alcance='global')),
    ...
    --      reservaciones
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='reservacion', accion='crear', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='reservacion', accion='leer', alcance='propietario')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='reservacion', accion='editar', alcance='propietario')),
    
    --      eventos
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='evento', accion='crear', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='evento', accion='leer', alcance='propietario')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='evento', accion='editar', alcance='propietario')),
    
    --      integrantes
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='integrante', accion='crear', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='integrante', accion='leer', alcance='global')),
    ((SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
     (SELECT id_permiso FROM public.permiso WHERE recurso='integrante', accion='editar', alcance='global')),
...
VALUES
    ...
    ((SELECT id_evento FROM public.evento WHERE nombre='Simposio de Negocios Digitales'), (SELECT id_usuario FROM public.usuario WHERE nombre_usuario='coordinacion.especialista.en.negocios.digitales')),
...
VALUES
    ...
    ((SELECT id_evento FROM public.evento WHERE nombre='Conferencia de Innovación Administrativa'),
    (SELECT id_recinto FROM public.recinto WHERE nombre='Auditorio C.P. Alfonso'),
...
VALUES
    ...
    ((SELECT id_evento FROM public.evento WHERE nombre='Congreso Internacional de Contaduría 2025'),
    (SELECT id_recinto FROM public.recinto WHERE nombre='Pantalla'), 2),
    ((SELECT id_evento FROM public.evento WHERE nombre='Congreso Internacional de Contaduría 2025'),
    (SELECT id_recinto FROM public.recinto WHERE nombre='Aula Magna de Profesores Eméritos'),
...
-- fotografia
INSERT INTO public.fotografia (id_fotografia,id_recinto)
VALUES
