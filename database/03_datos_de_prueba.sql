...
VALUES
    ...
    -- Administradores
    ('jefa.educacioncontinua','EDCP800101ABC','Paola','Estrada','Morales','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5551112222','5511122233','jefa.educacioncontinua@fca.unam.mx',
        ...
        ('jefa.estudiosposgrado','ESPG800102DEF','Mariana','Torres','García','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5552223333','5522233344','jefa.estudiosposgrado@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Jefa de la División de Estudios de Posgrado')),
        ('jefe.investigacion','DIVI800103GHI','Oscar','Pérez','Navarro','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5553334444','5533344455','jefe.investigacion@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Jefe de la Divisón de Investigación')),
        ('jefe.licadministracion','ADMN800104JKL','Daniel','Castro','Ramos','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5554445555','5544455566','jefe.licadministracion@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Jefe de la Licenciatura en Administración')),
        ('jefa.liccontaduria','CONT800105MNO','María','López','Santos','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5555556666','5555566677','jefa.liccontaduria@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Jefa de la Licenciatura en Contaduría')),
        ('jefe.licinformatica','INFO800106PQR','Héctor','Vega','Salinas','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5556667777','5566677788','jefe.licinformatica@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Jefe de la Licenciatura en Informática')),
        ('jefe.licnegocios','NEGI800107STU','Patricia','Ramos','Beltrán','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5557778888','5577788899','jefe.licnegocios@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Jefe de la Licenciatura en Negocios Internacionales')),
        ('secretario.difusioncultural','SDCU800108VWX','Raúl','Jiménez','Flores','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5558889999','5588899900','secretario.difusioncultural@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Secretario de Difusión Cultural')),
        ('jefa.centroinformatica','CINF800109YZA','Leticia','Rivera','Aguilar','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5559990000','5599900011','jefa.centroinformatica@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Jefa del Centro de Informática')),
        ('jefa.sistemaabierta','SUAE800110BCD','Elisa','Romero','Luna','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5550001111','5500011122','jefa.sistemaabierta@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Administrador'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Jefa del Sistema Universidad Abierta y Educación a Distancia')),

        -- Funcionarios
        ('coordinador.administracion.avanzada','NAVA800201ABC','Héctor','Navarro','Salinas','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5551010101','5510101010','coordinador.administracion.avanzada@fca.unam.mx',
        ...
        ('coordinadora.administracion.basica','RUID800202DEF','Daniela','Ruiz','Morales','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5552020202','5520202020','coordinadora.administracion.basica@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinadora de Administración Básica')),
        ('coordinador.auditoria','MEVR800203GHI','Ricardo','Mendoza','Torres','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5553030303','5530303030','coordinador.auditoria@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador de Auditoría')),
        ('coordinador.contabilidad.avanzada','DOGA800204JKL','Gabriela','Domínguez','Navarro','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5554040404','5540404040','coordinador.contabilidad.avanzada@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinadora de Contabilidad Avanzada')),
        ('coordinadora.contabilidad.basica','HEHU800205MNO','Hugo','Hernández','Santos','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5555050505','5550505050','coordinadora.contabilidad.basica@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador de Contabilidad Básica')),
        ('coordinador.costos.presupuestos','JICA800206PQR','Carmen','Jiménez','Vega','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5556060606','5560606060','coordinador.costos.presupuestos@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador de Costos y Presupuestos')),
        ('coordinador.derecho','MOLU800207STU','Luis','Morales','Castro','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5557070707','5570707070','coordinador.derecho@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador de Derecho')),
        ('coordinadora.economia','CAIS800208VWX','Isabel','Castro','Ramos','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5558080808','5580808080','coordinadora.economia@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinadora de Economía')),
        ('coordinador.finanzas','VEPA800209YZA','Pablo','Vega','Salazar','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5559090909','5590909090','coordinador.finanzas@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador de Finanzas')),
        ('coordinadora.fiscal','SATE800210BCD','Teresa','Salazar','Jiménez','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5551111111','5511111111','coordinadora.fiscal@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinadora de Fiscal')),
        ('coordinador.informatica','ALSE800211EFG','Sergio','Álvarez','Ortega','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5552222222','5522222222','coordinador.informatica@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador de Informática')),
        ('coordinadora.matematicas','ROCA800212HIJ','Carla','Romero','Navarro','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5553333333','5533333333','coordinadora.matematicas@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador de Matemáticas')),
        ('coordinador.mercadotecnia','PIJA800213KLM','Javier','Pineda','Gómez','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5554444444','5544444444','coordinador.mercadotecnia@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador de Mercadotecnia')),
        ('coordinadora.metodologia.investigacion.etica','BEAN800214NOP','Ana','Beltrán','Sánchez','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5555555555','5555555555','coordinadora.metodologia.investigacion.etica@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador de Metodología de la Investigación y Ética')),
        ('coordinador.academico','ESPA800215QRS','Paola','Estrada','Morales','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5556666666','5566666666','coordinador.academico@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador Académico')),
        ('coordinador.administrativo','ESPA800216TUV','Paola','Estrada','Morales','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5557777777','5577777777','coordinador.administrativo@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador Administrativo')),
        ('difusion.promocion','ESPA800217WXY','Paola','Estrada','Morales','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5558888888','5588888888','difusion.promocion@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Difusión y Promoción')),
        ('coordinacion.especializacion.fiscal','TORR800218ZAB','Ricardo','Torres','Navarro','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5559999999','5599999999','coordinacion.especializacion.fiscal@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinación de la Especialización en Fiscal')),
        ('coordinacion.maestria.alta.direccion','TORR800219BCD','Ricardo','Torres','Navarro','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5551212121','5512121212','coordinacion.maestria.alta.direccion@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinación de la Maestría en Alta Dirección')),
        ('coordinacion.maestria.auditoria','TORR800220CDE','Ricardo','Torres','Navarro','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5552323232','5523232323','coordinacion.maestria.auditoria@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinación de la Maestría en Auditoría')),
        ('coordinacion.maestria.finanzas','TORR800221DEF','Ricardo','Torres','Navarro','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5553434343','5534343434','coordinacion.maestria.finanzas@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinación de la Maestría en Finanzas')),
        ('coordinacion.maestria.negocios.turismo','TORR800222EFG','Ricardo','Torres','Navarro','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5554545454','5545454545','coordinacion.maestria.negocios.turismo@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        ...
        ('coordinacion.especializaciones.alta.direccion.rh.mercadotecnia','TORR800223FGH','Ricardo','Torres','Navarro','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5555656565','5556565656','coordinacion.especializaciones.alta.direccion.rh.mercadotecnia@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        ...
        ('coordinador.maestria.informatica.administrativa','TORR800224GHI','Ricardo','Torres','Navarro','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5556767676','5567676767','coordinador.maestria.informatica.administrativa@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador de la Maestría en Informática Administrativa')),
        ('coordinador.deportivo','VEGA800225HIJ','Cinthia','Vega','Salinas','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5557878787','5578787878','coordinador.deportivo@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
        (SELECT id_puesto FROM public.puesto WHERE nombre = 'Coordinador deportivo')),
        ('coordinadora.difusion','GARE800226IJK','Rebeca','García','Morales','01391dc81025f293bf2e40133fb84fb4358426b089c76206b6e7cb2753774c5a','5558989898','5589898989','coordinadora.difusion@fca.unam.mx',
        (SELECT id_rol_usuario FROM public.rol_usuario WHERE nombre = 'Funcionario'),
