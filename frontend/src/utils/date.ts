import { addMonths, eachDayOfInterval, endOfMonth, format, isAfter, isBefore, isWithinInterval, parseISO, startOfMonth, startOfToday } from 'date-fns' // <-- agrega startOfToday
...
// NUEVO: true si la fecha es hoy o futura (no mostramos eventos que ya pasaron)
export const isUpcoming = (iso:string) => !isBefore(parseISO(iso), startOfToday())
